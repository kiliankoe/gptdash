...
A separate version was built for [39c3](https://events.ccc.de/congress/2025/infos/startpage.html), see `/congress`. This version is a bit different to the previous iterations, most notably there's now a separation between players submitting answers and the audience voting on them.

There are plans to turn this into an always-online version playable whenever by small groups, we just haven't gotten around to that yet.
